...
Button(root, text='Calendar', command=example1).pack(padx=10, pady=10)
Button(root, text='Calendar with events', command=example2).pack(padx=10, pady=10)
Button(root, text='DateEntry', command=example3).pack(padx=10, pady=10)
